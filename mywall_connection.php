...
define('DB_DATABASE', 'mywall'); //make sure to set your database, replace 'mydb' 
// with the name of your database, this is the only thing you need to change in 
// this document to connect to your database 
